            ...
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <?php
                        ...
                        include("modal/new_solution.php");
                    ?>
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Tickets</h2>
...
$( "#sol" ).submit(function( event ) {
  $('#sol_data').attr("disabled", true);
...
$( "#rep" ).submit(function( event ) {
  $('#rep_data').attr("disabled", true);
  
 var parametros = $(this).serialize();
     $.ajax({
            type: "POST",
            url: "action/addreply.php",
            data: parametros,
             beforeSend: function(objeto){
                $("#result4").html("Mensaje: Cargando...");
              },
            success: function(datos){
            $("#result4").html(datos);
            $('#rep_data').attr("disabled", false);
            load(1);
          }
    });
  event.preventDefault();
